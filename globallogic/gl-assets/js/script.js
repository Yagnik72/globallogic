...
jQuery(document).ready(function () {
    ...
    if ($('.home-page-carousel-inner')) {
        $('.home-page-carousel-inner').slick({
            rows: 1,
            slidesToShow: 1,
            slidesToScroll: 1,
            autoplay: true,
    ...
    // flexible-parts > testimonial-carousel
    if ($('.testimonial-carousel')) {
        var q = $('.testimonial-carousel');
        q.slick({
            rows: 1,
            slidesToShow: 1,
            slidesToScroll: 1,
    ...
    // flexible-parts > image-logo-carousel
    if ($('.image-logo-carousel')) {
        var imageLogoCarousel = $('.image-logo-carousel');
        
        imageLogoCarousel.slick({
            rows: 1,
            slidesToShow: imageLogoCarousel.data('slideshow'),
            slidesToScroll: 1,
            autoplay: true,
            autoplaySpeed: 7000,
            arrows: true,
    ...
    // flexible-parts > relatedContentSlick
    if ($('#relatedContentSlick')) {
        var relatedContentSlick = $('#relatedContentSlick');
        relatedContentSlick.slick({
            rows: 1,
            slidesToShow: 3,
            slidesToScroll: 1,
            autoplay: false,
        ...
        $('.related_group .carousel-nav.bottom .prev').click(function () {
            relatedContentSlick.slick('slickPrev');
        })

        $('.related_group .carousel-nav.bottom .next').click(function () {
            relatedContentSlick.slick('slickNext');
        });
    }

    // flexible-parts > why_gl_carousel
    if($('#why_gl_carousel')){
        var careerSlick = $('#why_gl_carousel');
        if (careerSlick) {
            careerSlick.slick({
                rows: 1,
                slidesToShow: 3,
